...
var MemoryRecord = function () {
  (0, _createClass3.default)(MemoryRecord, null, [{
    ...
    get: function get() {
      ...
      return this._values || _lodash2.default.map(this.define, function (e, i) {
    ...
    get: function get() {
      ...
      this._keys_hash = this._keys_hash || _lodash2.default.reduce(this.values, function (a, e) {
        if (e.key in a) {
    ...
    get: function get() {
      ...
      this._codes_hash = this._codes_hash || _lodash2.default.reduce(this.values, function (a, e) {
        if (e.code in a) {
    ...
    key: "keys",
    get: function get() {
      this._keys = this._keys || (0, _keys2.default)(this.keys_hash);
      return this._keys;
    }
  }, {
    key: "codes",
    ...
    key: "names",
    get: function get() {
      this._names = this._names || this.values.map(function (e) {
        return e.name;
      });
      return this._names;
    }
